...
minetest.register_node("liteworks:autocrafter", {
	description = S("Autocrafter"),
	drawtype = "normal",
	tiles = {"liteworks_autocrafter.png"},
	...
	on_receive_fields = function(pos, formname, fields, sender)
		if (fields.quit and not fields.key_enter_field) or not liteworks.may_configure(pos, sender) then
			return
		end
		local meta = minetest.get_meta(pos)
		if fields.on then
